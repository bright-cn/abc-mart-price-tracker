...
[![ABC-MART Price Tracker](https://img.shields.io/badge/ABC-MART%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://bright.cn/products/insights/price-tracker/abc-mart)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://bright.cn/products/insights/price-tracker/abc-mart)

实时 ABC-MART 价格追踪——日本最大的鞋类零售连锁。两种入门方式：**全托管**情报平台，或使用 Bright Data 的 AI Scraper Builder 构建的**自定义 scraper**。

---

## 选项 1：Bright Insights - AI 驱动的价格追踪（推荐）

**[Bright Insights](https://bright.cn/products/insights/price-tracker/abc-mart)** 是 Bright Data 的全托管零售情报平台。无需构建 scraper，无需维护基础设施——只需将结构化、可直接分析的价格数据交付到仪表板、数据 feed 或你的 BI 工具中。
...
> **每月 $250 起 - [获取定制报价 →](https://bright.cn/products/insights/price-tracker/abc-mart)**

---

## 选项 2：构建你自己的 ABC-MART Scraper

没有现成的 ABC-MART scraper API？没问题。Bright Data 的 **AI Scraper Builder** 只需点击几下即可生成自定义 ABC-MART scraper——无需编写代码。

### 几分钟内构建你的 ABC-MART scraper

**[打开 ABC-MART AI Scraper Builder →](https://bright.cn/products/web-scraper/abc-mart)**
...
- 一个用于 ABC-MART 的 **Web Scraper ID**（来自上面的构建步骤）
...
1. **克隆此 repository**
   ...
   ```bash
   git clone https://github.com/bright-cn/abc-mart-price-tracker.git
...
3. **配置凭据**
   ...
   > **你的 Web Scraper ID**
   > 将你在 [AI Scraper Builder dashboard](https://bright.cn/products/web-scraper/abc-mart) 中获取的 Web Scraper ID
...
当你的 ABC-MART scraper 构建完成，并且已在 `.env` 中配置好 Web Scraper ID 后，Python 接口的使用方式如下：

### 1. 通过 URL 追踪特定商品

传入 ABC-MART 商品 URL 列表以获取结构化价格数据：
...
- 🌟 [ABC-MART Price Tracker - Bright Insights (Managed)](https://bright.cn/products/insights/price-tracker/abc-mart)
- 🏗️ [Build a ABC-MART Scraper](https://bright.cn/products/web-scraper/abc-mart)
